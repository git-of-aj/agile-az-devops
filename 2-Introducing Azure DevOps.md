# Explaion SDLC 
# DevOps Server
> azure devops express during installations asks - wish to install sql server or pre-installed
> the domain you provided for access should be resolvable by vm
